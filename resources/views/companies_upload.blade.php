...
<div class="container show-data">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Upload Companies Information <div class="pull-right-back"> <span> <a href="/companies">Back</a></span></div></div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            Upload all the branches of your company here. Download the template, fill the details and upload the template(template should be in .csv format)
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            @csrf
                            {{ Form::hidden('name','Company', ['class'=>'form-control']) }}
